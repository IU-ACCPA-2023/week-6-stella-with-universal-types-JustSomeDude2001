...
public class ALabelledPattern  extends LabelledPattern {
  ...
  public <R,A> R accept(stella.Absyn.LabelledPattern.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof stella.Absyn.ALabelledPattern) {
      stella.Absyn.ALabelledPattern x = (stella.Absyn.ALabelledPattern)o;
