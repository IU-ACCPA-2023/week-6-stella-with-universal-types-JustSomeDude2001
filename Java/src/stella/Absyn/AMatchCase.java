...
public class AMatchCase  extends MatchCase {
  ...
  public <R,A> R accept(stella.Absyn.MatchCase.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof stella.Absyn.AMatchCase) {
      stella.Absyn.AMatchCase x = (stella.Absyn.AMatchCase)o;
