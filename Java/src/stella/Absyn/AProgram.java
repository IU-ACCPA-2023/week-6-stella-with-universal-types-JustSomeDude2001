...
public class AProgram  extends Program {
  ...
  public <R,A> R accept(stella.Absyn.Program.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof stella.Absyn.AProgram) {
      stella.Absyn.AProgram x = (stella.Absyn.AProgram)o;
