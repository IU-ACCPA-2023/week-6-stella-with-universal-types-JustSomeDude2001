...
public class AParamDecl  extends ParamDecl {
  ...
  public <R,A> R accept(stella.Absyn.ParamDecl.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof stella.Absyn.AParamDecl) {
      stella.Absyn.AParamDecl x = (stella.Absyn.AParamDecl)o;
