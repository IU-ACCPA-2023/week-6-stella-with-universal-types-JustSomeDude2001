...
public class Interpret
{
  ...
  {
    Interpret t = new Interpret(args);
    try
    {
      stella.Absyn.Program ast = t.parse();
      compiler.TypeCheck.typecheck(ast);
      ...
      if (args.length > 0) {
        ...
        stella.Absyn.Expr inputExpr = ec.result;
        stella.Absyn.Expr resultExpr = compiler.Eval.evalMainWith(ast, inputExpr);
